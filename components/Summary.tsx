        ...
        <div>
            ...
            >
                <div className="flex w-full">
                    ...
                    <div className="flex-1 p-8 space-y-4 bg-black text-white rounded-tl-lg rounded-bl-lg flex flex-col justify-center items-center">
                        ...
                        <Button
                            ...
                            className="bg-white text-black hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 mt-4"
                        >
                    ...
                    <div className="flex-1 p-8 space-y-4 bg-white text-black rounded-tr-lg rounded-br-lg flex flex-col justify-center items-center">
                        ...
                        <Button
                            ...
                            className="bg-black text-white hover:bg-gray-900 transition-all duration-300 transform hover:scale-105 mt-4"
                        >
